                    ...
                    <div className="relative z-20 bg-transparent px-5 pb-4 pt-4 text-[#1a2330]">
                      ...
                      <div className="mt-4 flex items-center justify-between gap-3">
                        ...
                        <StorefrontAddToCartTrigger
                          ...
                          product={item}
                          className={`relative z-20 size-11 shrink-0 rounded-full p-0 text-[#1a2330] transition-[transform,filter] duration-300 ease-out hover:-translate-y-0.5 hover:brightness-95 ${categoryShadowClasses[index % categoryShadowClasses.length]}`}
                        >
                          <HugeiconsIcon
